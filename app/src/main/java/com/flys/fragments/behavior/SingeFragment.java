...
public class SingeFragment extends AbstractFragment {

    @Click(R.id.next)
    protected void nextChapitre() {
        mainActivity.navigateToView(mainActivity.PLANTOIR_FRAGMENT, ISession.Action.SUBMIT);
    }
    @Override
    ...
    protected int getNumView() {
        return mainActivity.SINGE_FRAGMENT;
    }
